...
// CSE 271 - B
// 9/4/2026
// Project 1, currently working through phase 1 of methods, overall project will use file reading skills.
...
public class ScriptReviewTool {
    ...
    public static void main(String[] args) {
        ...
        // Storing our given file name into a variable in the main method
        String fileName = getFileName(kb);

        System.out.println("File name: " + fileName);

        // Storing our user's choice into a variable into the main method.
        int userChoice = getUserChoice(kb);

        System.out.println("User choice: " + userChoice);

        String tongueTwister = "A man, a plan, a canal. Panama";
        // Cleaning a string
        System.out.println("\nOriginal string: " + tongueTwister + "\nClean string: " + clean(tongueTwister));

        String palindrome = "racecar";

        // Testing isPalindrome()
        System.out.println("\nIs tungsten a palindrome? " + isPalindrome("tUnGsTeN"));

        System.out.println("\nIs racecar a palindrome? " + isPalindrome(palindrome));

        System.out.println("\nIs 'a' a palindrome? " + isPalindrome("a"));
        
        System.out.println("\n" + isPalindrome(""));

        // Testing getValue()

        System.out.println("\nThe value of 'The' is: " + getValue("The"));
